...
function script1(){//нумерация скриптов соответствующая нумерации заданий
	...
	document.write('<input type="text" pattern ="[a-z0-9-]+@[a-z]+\.+[a-z]{2,6}" placeholder="mymail@mail.com"/>');
	//я просто написал регулярное выражение для почты, 1я группа символов - любая строчная латинская буква, цифры, а так же дефис. Дальше следует коммерческий at. После группа символов - любая строчная латинская буква, после следует точка, перед точкой обратный слеш чтобы отделить точку как спец символ, после точки группа символов от 2 до 6, опять же, любая строчная латинская буква
